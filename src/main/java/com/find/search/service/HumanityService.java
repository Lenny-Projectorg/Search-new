...
public interface HumanityService {
    ...
    //分页查询方法:两个参数：页码，每页条数
    HashMap<String, Object> findByPage(Integer page, Integer pageRow);

    //指定用户发布寻人启事分页查询方法:两个参数：页码，每页条数
    HashMap<String, Object> findPersonByPage(Integer page, Integer pageRow,String userEmail);

    //通过输入用户邮箱查询指定用户发布的寻人启事
    List<Humanity> selectHumanityByUserId(String userEmail);
